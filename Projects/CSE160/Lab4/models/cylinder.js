class Cylinder extends Model{
  ...
  //1,2,3  &  3,2,4   add 2 and repeat for just TRIANGLES
    ...
    constructor(color, endcaps, direction) {
      super(color);
      ...
      for (i=0; i<n; i++){
        ...
        if(direction == "side"){
          ...
          cylinder_points = cylinder_points.concat((x_next/m_sqrt_next),(y_next/m_sqrt_next),0);
          cylinder_points = cylinder_points.concat((x_next/m_sqrt_next), (y_next/m_sqrt_next),1);
        }
        else{
      ...
      if (endcaps == "yes"){
        ...
        for (i=0; i<n; i++){
          ...
          //switched y and z so it is facing up instead of out
          if (direction == "side"){
            cylinder_points = cylinder_points.concat((x_ends/m_sqrt_ends), (y_ends/m_sqrt_ends),0);
            cylinder_points = cylinder_points.concat((x_ends/m_sqrt_ends), (y_ends/m_sqrt_ends),1);
          }
          else{
